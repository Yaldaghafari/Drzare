    ...
    public partial class Receivable : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "INSERT INTO Receivable (CustomerID ,Date, Amount , Details) VALUES ( @CustomerID, @Date , @Amount, @Details)";
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlConnection connection = new SqlConnection(con);
                connection.Open();
                string query = "DELETE FROM Receivable WHERE ID = @ID ";
                SqlCommand command = new SqlCommand(query, connection);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlConnection connection = new SqlConnection(con);
                connection.Open();
                string query = "UPDATE Receivable SET CustomerID =@CustomerID ,Date=@Date, Amount=@Amount, Details=@Details WHERE ID=@ID ";
                SqlCommand command = new SqlCommand(query, connection);
                command.Parameters.AddWithValue("@ID", ID);
                command.Parameters.AddWithValue("@CustomerID", CUSTID);
                command.Parameters.AddWithValue("@Date", DATE);
